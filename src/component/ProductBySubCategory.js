...
this.setState({clickedfilter:false})
  ...
  fetchSaverProducts(){
    ...
    fetch(URL+"/APP-API/Product/GetStoreProductByCategory",{
      method:'post',
      header:{
                         ...
                         <form class="form-header">
                             <div class="input-group">
                                 <input autocomplete="off" onChange={this.SearchProducts} id="name" type="text" class="form-control" aria-label="Amount (to the nearest dollar)"
                                     placeholder={"Search Product in "+this.props.match.params.categoryName}/>
...
export default withRouter(ProductBySubCategory);
